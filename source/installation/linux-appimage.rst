...
.. prompt:: bash
   ...
   sudo ./glpi-agent-1.15-x86_64.AppImage --install --server <URL>
...
.. prompt:: bash
   ...
   chmod +x glpi-agent-1.15-x86_64.AppImage
   sudo ./glpi-agent-1.15-x86_64.AppImage --upgrade
...
.. hint::
   ...
   .. prompt:: bash
      ...
      ./glpi-agent-1.15-x86_64.AppImage --help
...
* Extract AppImage content:
   ...
   .. prompt:: bash
      ...
      ./glpi-agent-1.15-x86_64.AppImage --appimage-extract
