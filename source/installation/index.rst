...
.. prompt:: bash
   ...
   snap install --classic --dangerous GLPI-Agent-1.17_amd64.snap
...
.. prompt:: bash
   ...
   perl glpi-agent-1.17-with-snap-linux-installer.pl --help
...
.. prompt:: bash
   ...
   tar xfz GLPI-Agent-1.17.tar.gz
   cd GLPI-Agent-1.17
...
.. prompt:: bash
   ...
   tar xzf GLPI-Agent-1.17.tar.gz
   cd GLPI-Agent-1.17
