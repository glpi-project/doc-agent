...
.. prompt:: bash
   ...
   snap install --classic --dangerous GLPI-Agent-1.15_amd64.snap
...
.. prompt:: bash
   ...
   perl glpi-agent-1.15-linux-installer.pl --help

or if you use the installer embedding **snap** package:

.. prompt:: bash

   perl glpi-agent-1.15-with-snap-linux-installer.pl --help
...
.. prompt:: bash
   ...
   tar xfz GLPI-Agent-1.15.tar.gz
   cd GLPI-Agent-1.15
...
.. prompt:: bash
   ...
   tar xzf GLPI-Agent-1.15.tar.gz
   cd GLPI-Agent-1.15
