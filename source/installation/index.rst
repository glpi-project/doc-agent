...
- **Reconfigure**
 ...
 - It's useful when you just need to change a parameter like an GLPI_URL, for example.
- **Repair**
...
- **Run uninstall**
 - Here you can uncomment the agents you want the script to uninstall (FusionInventory Agent or OCSInventory Agent)
